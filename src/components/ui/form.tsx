  ...
  ({ className, error, ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={cn(
          'block w-full rounded-md border border-secondary-300 text-black bg-white py-2 px-3 shadow-sm',
  ...
  ({ className, error, options, placeholder, ...props }, ref) => {
    return (
      <select
        ref={ref}
        className={cn(
          'block w-full rounded-md border border-secondary-300 bg-white bg-secondary-100 text-black py-2 px-3 shadow-sm',
          'focus:outline-none focus:ring-1 focus:ring-secondary-900 focus:border-secondary-900',
          'placeholder:text-secondary-400 sm:text-sm',
          error && 'border-red-300 focus:ring-red-500 focus:border-red-500',
          className
