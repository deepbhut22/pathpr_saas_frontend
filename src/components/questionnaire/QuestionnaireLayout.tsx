...
//   return (
//     <div className="mx-auto px-4 bg-white sm:px-6 py-8">
//       <div className="mb-5">
...
//                   onNext(step.id as Step);
//                   return;
//                 }
//                 navigate(`/${params.slug}/data-form/${step.id}/${params.token}`, { state: { firm: firm, consultant: consultant } })
//               }}
//               key={step.id} 
...
//             >
//               {params.token === undefined || '' ? 'Submit' : 'Update'}
//             </Button>
//           )}
//         </div>
//       </div>
