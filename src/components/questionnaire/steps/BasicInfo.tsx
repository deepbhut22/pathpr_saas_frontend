...
export default function BasicInfo({
  ...
  const { userProfile, updateBasicInfo } = useUserFormDataStore();
  const { basicInfo } = userProfile.profileData;
    ...
    <Form>
      <FormSection title="Personal Information" description="Please provide your basic personal details.">
        ...
        <FormGroup>
          ...
          <FormHelperText>We will use this to get in touch with you about your immigration process.</FormHelperText>
        </FormGroup>
