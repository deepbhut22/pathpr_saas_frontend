...
export default function Education({
  ...
  const { userProfile, updateEducationInfo, addEducation, removeEducation } = useUserFormDataStore();
  const { educationInfo } = userProfile.profileData;
        ...
        {educationInfo.hasPostSecondary && (
          <>
            <div className="border border-secondary-200 rounded-md p-4 mt-6 bg-secondary-50">
              <h3 className="text-lg font-medium mb-4 text-black">Add Post-Secondary Education</h3>
