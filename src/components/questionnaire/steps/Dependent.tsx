...
export default function Dependent({
  ...
  const { userProfile, updateDependentInfo, addDependent, removeDependent } = useUserFormDataStore();
  const { dependentInfo } = userProfile.profileData;
        ...
        {dependentInfo.hasDependents && (
          <>
            <div className="border border-secondary-200 rounded-md p-4 mt-6 bg-secondary-50">
              <h3 className="text-lg font-medium mb-4 text-black">Add Dependent</h3>
